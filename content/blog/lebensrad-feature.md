---
title: 'Das Lebensrad als zentrales Feature der KLARE App'
date: '2025-05-02'
author: 'Sascha Kohler'
excerpt: 'Das Lebensrad ist ein wichtiges Tool in der KLARE Methode. Erfahre, wie wir dieses Feature in der App umgesetzt haben.'
category: 'Features'
coverImage: '/images/blog/life-wheel.jpg'
---

# Das Lebensrad als Zentrum der KLARE App

Das Lebensrad (oder "Wheel of Life") ist ein seit Jahrzehnten bewährtes Tool zur ganzheitlichen Bewertung verschiedener Lebensbereiche. In der KLARE App haben wir dieses klassische Konzept neu interpretiert und zu einem dynamischen, interaktiven Feature weiterentwickelt, das als Basis für den gesamten Transformationsprozess dient.

## Was ist das Lebensrad?

Das Lebensrad ist eine visuelle Darstellung deiner Zufriedenheit in verschiedenen Lebensbereichen. Es ermöglicht dir, auf einen Blick zu erkennen, welche Bereiche deines Lebens bereits in Balance sind und wo noch Entwicklungspotenzial besteht.

In der KLARE App haben wir uns für folgende acht Lebensbereiche entschieden:
...
<CalloutBox type="info">
  ...
  <p>
    Unsere Forschung hat gezeigt, dass acht Bereiche die optimale Balance zwischen Vollständigkeit und Übersichtlichkeit bieten. Weniger Bereiche wären zu grob, mehr würden schnell unübersichtlich werden.
  </p>
</CalloutBox>

## Die technische Umsetzung des Lebensrads

Die Entwicklung eines intuitiven, visuell ansprechenden und technisch robusten Lebensrads war eine der größten Herausforderungen bei der App-Entwicklung. Wir haben uns für eine vektorbasierte SVG-Implementation entschieden, die sowohl Performance als auch Flexibilität bietet.
...
## Das Lebensrad als Diagnose-Tool

In der KLARE Methode dient das Lebensrad als fundamentales Diagnose-Tool, um den aktuellen Ist-Zustand zu verstehen und Bereiche mit dem größten Entwicklungspotenzial zu identifizieren.
...
<GradientBox from="from-klare-k" to="to-klare-l">
  <h3 className="text-xl font-bold mb-4">Warum die Diskrepanz wichtig ist</h3>
  <p>
    Die Diskrepanz zwischen Ist und Soll zeigt nicht nur, wo Entwicklungspotenzial besteht, sondern auch, wo innere Motivation für Veränderung vorhanden ist. Je größer die Diskrepanz, desto stärker der innere Antrieb zur Transformation in diesem Bereich.
  </p>
</GradientBox>

## Dynamische Entwicklung über Zeit

Eine Besonderheit unseres Lebensrad-Features ist die Möglichkeit, die Entwicklung über Zeit zu verfolgen. Durch regelmäßige Bewertungen entsteht eine Zeitleiste der persönlichen Entwicklung, die folgende Einsichten ermöglicht:
...
Die App generiert zudem automatisch Insights auf Basis dieser Daten, wie zum Beispiel:
...
Das Lebensrad ist eng mit anderen Features der KLARE App verknüpft:

1. **KLARE-Methode-Module**: Für jeden Lebensbereich gibt es spezifische Übungen in den K, L, A, R und E Modulen.
2. **Journal**: Tagebucheinträge können mit bestimmten Lebensbereichen verknüpft werden.
...
Bei der Implementierung des Lebensrads standen wir vor einigen interessanten technischen Herausforderungen:

### 1. Performance-Optimierung

Die SVG-Berechnung und -Renderung in React Native kann bei komplexen Formen rechenintensiv sein. Wir haben eine Kombination aus Memoization und reduzierten Re-Renders implementiert:
...
Das Lebensrad muss auf verschiedenen Bildschirmgrößen gut aussehen und nutzbar sein. Wir haben eine responsive Skalierung implementiert, die die Größe des Rads, die Schriftgröße und die Interaktionspunkte an die Bildschirmgröße anpasst.

### 3. Datenvisualisierung

Für die zeitliche Entwicklung haben wir verschiedene Charting-Bibliotheken evaluiert und uns schließlich für eine angepasste Version von Recharts entschieden, die sowohl Performance als auch Flexibilität bietet.

## Ausblick: Die Zukunft des Lebensrads
...
Das Lebensrad ist mehr als nur ein Feature – es ist das zentrale Navigationssystem auf deinem Weg zu mehr Kongruenz und Erfüllung. Durch die visuelle Darstellung deiner Lebenssituation erkennst du nicht nur, wo du stehst, sondern auch, wohin du gehst und welche Bereiche deines Lebens besondere Aufmerksamkeit verdienen.

Hast du das Lebensrad schon in der KLARE App ausprobiert? Wir sind gespannt auf dein Feedback und deine Erfahrungen!