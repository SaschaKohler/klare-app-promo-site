    ...
    <div className="flex items-center space-x-2">
      <Link 
        ...
        className={`px-2 py-1 text-sm font-medium rounded ${
          currentLang === 'de' ? 'bg-klare-k text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300'
        }`}
      >
        DE
      </Link>
      <Link 
        ...
        className={`px-2 py-1 text-sm font-medium rounded ${
          currentLang === 'en' ? 'bg-klare-k text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300'
        }`}
      >
        EN
      </Link>
