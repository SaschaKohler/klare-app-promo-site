...
export const GradientBox = ({ children, from, to }: { children: React.ReactNode; from?: string; to?: string }) => {
...
export const CodeSnippet = ({ language, code, title }: { language: string; code: string; title?: string }) => (
  <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 my-8">
    {title && (
...
export const CalloutBox = ({ children, type = 'info' }: { children: React.ReactNode; type?: 'info' | 'warning' | 'success' }) => {
  const styles = {
