    ...
    ? [
        {
          ...
          description:
            "Visualize your life areas and identify imbalances with the dynamic life wheel.",
          icon: "🎯",
        },
        {
          title: "Personal Insights",
          description:
            "Gain deep insights into your patterns and blockages through guided reflection exercises.",
          icon: "💡",
        },
        {
          title: "Progress Tracking",
          description:
            "Track your progress on the path to congruence with detailed reports and visualizations.",
          icon: "📊",
        },
        {
          title: "Meditation Exercises",
          description:
            "Strengthen your inner clarity with specially developed meditations and mindfulness exercises.",
          icon: "🧘",
        },
        {
          title: "Journal Function",
          description:
            "Document your thoughts, insights and progress with the built-in digital journal.",
          icon: "📓",
        },
        {
          title: "Resource Library",
          description:
            "Access an extensive collection of exercises, articles and tools for personal growth.",
          icon: "📚",
        },
      ]
    : [
        {
          ...
          description:
            "Visualisiere deine Lebensbereiche und identifiziere Ungleichgewichte mit dem dynamischen Lebensrad.",
          icon: "🎯",
        },
        {
          title: "Persönliche Einsichten",
          description:
            "Erhalte tiefgehende Einblicke in deine Muster und Blockaden durch geführte Reflexionsübungen.",
          icon: "💡",
        },
        {
          title: "Fortschritts-Tracking",
          description:
            "Verfolge deinen Fortschritt auf dem Weg zur Kongruenz mit detaillierten Berichten und Visualisierungen.",
          icon: "📊",
        },
        {
          title: "Mediationsübungen",
          description:
            "Stärke deine innere Klarheit mit speziell entwickelten Meditationen und Achtsamkeitsübungen.",
          icon: "🧘",
        },
        {
          title: "Journal-Funktion",
          description:
            "Dokumentiere deine Gedanken, Erkenntnisse und Fortschritte mit dem eingebauten digitalen Tagebuch.",
          icon: "📓",
        },
        {
          title: "Ressourcen-Bibliothek",
          description:
            "Greife auf eine umfangreiche Sammlung von Übungen, Artikeln und Tools zur persönlichen Entwicklung zu.",
          icon: "📚",
        },
      ];
