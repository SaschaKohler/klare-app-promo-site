    ...
    <>
      ...
      <header className="py-16 relative overflow-hidden">
        ...
        <div
          ...
          style={{
            background: `linear-gradient(135deg, var(--klare-k), var(--klare-a))`,
          }}
        ></div>
        ...
        <div className="max-w-3xl mx-auto bg-white dark:bg-dark-klare-card p-8 rounded-lg shadow-sm">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  ...
                  <a
                    ...
                    className="inline-flex items-center text-klare-a dark:text-dark-klare-a border-b border-klare-a dark:border-dark-klare-a transition-opacity hover:opacity-80"
                  >
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              Bei Beschwerden wenden Sie sich bitte an: office@sascha-kohler.at oder an die
              Plattform zur Online-Streitbeilegung der Europäischen Kommission:
              <a
                href="https://ec.europa.eu/consumers/odr"
                target="_blank"
                rel="noopener noreferrer"
                className="ml-1 underline text-klare-a dark:text-dark-klare-a"
              >
      ...
      <div className="container mx-auto px-4 md:px-8 mb-16">
        <div className="max-w-3xl mx-auto">
          <Link
            href="/"
            className="inline-flex items-center font-medium text-klare-k dark:text-dark-klare-k transition-colors hover:text-klare-a dark:hover:text-dark-klare-a"
          >
            <svg
