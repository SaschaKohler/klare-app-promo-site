...
const DatenschutzPage: React.FC = () => {
  ...
  const AccordionSection = ({
    ...
    <div className="border-b pb-2">
      <button
        className="flex justify-between items-center w-full py-3 text-left font-medium transition-colors text-klare-k dark:text-dark-klare-k"
            ...
            <AccordionSection id="analytik" title="4. Webanalyse und Tracking">
              ...
              <p className="mt-2">
                ...
                <a
                  ...
                  className="underline text-klare-k dark:text-dark-klare-k"
                >
